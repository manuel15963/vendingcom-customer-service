package com.vendingcom.customer_service.util.security;
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        // Consulta de clientes: ADMIN y SUPERVISOR
                        .pathMatchers(HttpMethod.GET, "/api/v1/customers/**").hasAnyRole("ADMIN", "SUPERVISOR")
                        ...
                        .pathMatchers(HttpMethod.PATCH, "/api/v1/customers/**").hasRole("ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/api/v1/customers/**").hasRole("ADMIN")

                        // Auditoría: solo ADMIN
                        .pathMatchers("/api/v1/customer-audit-logs/**").hasRole("ADMIN")
